...
##### 2.0) Read Trimming
# Use job script 01_fastp.sh
# Trimmed files will be output into trim/ directory

##### 3.0) Alignment
# First, need to index the genome
# Run script 02_index_genome.sh
...
# We will use the genome analysis toolkit (gatk) to remove sequence duplicates
